...
```{r}
Capacidad_UCI <- df_general_pais_ultima_fecha$UCI
gauge(Capacidad_UCI, min = 0, max = 359, gaugeSectors(
  success = c(0, 150), warning = c(151, 250), danger = c(251, 359)
))
```
...
```{r}
p_bins <- c(0,1000,2000,4000,10000,15000,Inf)
...
```{r}
a_bins <- c(0,500,1000,1500,2000,4000,5000,Inf)
...
```{r}
r_bins <- c(0,500,1000,2000,3000,3500,4000,Inf)
...
```{r}
f_bins <- c(0,50,100,150,200,250,Inf)
