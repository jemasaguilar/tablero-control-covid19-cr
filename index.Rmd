...
```{r}
p_bins <- c(0,500,1000,2000,3000,4000,5000,10000,15000,Inf)
...
```{r}
a_bins <- c(0,500,1000,1100,1200,1300,1400,1500,2000,3000,4000,5000,Inf)
...
```{r}
r_bins <- c(0,500,1000,1500,2000,2500,3000,3500,4000,Inf)
...
```{r}
f_bins <- c(0,25,50,75,100,150,200,250,Inf)
